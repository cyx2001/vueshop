<template>
  <div class="bg-white px-3" style="margin: -20px; margin-bottom: 0 !important">
    ...
    >
      ...
      <el-table-column align="center" prop="price" label="开票金额">
      </el-table-column>
      <el-table-column align="center" prop="price" label="抬头">
      </el-table-column>
      <el-table-column align="center" prop="content" label="发票内容">
      </el-table-column>
      <el-table-column align="center" prop="code" label="纳税人识别号">
      </el-table-column>
